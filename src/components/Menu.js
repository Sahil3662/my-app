...
const Menu =()=>{
    ...
    if(menuList.length===0) {
        ...
        const{ name,cuisines,areaName,sla,avgRating,totalRatingsString, costForTwoMessage}=menuList[0].card?.card?.info;
        ...
        <div className="container mt-4" style={{width:"60%"}}>
            ...
            <div className="d-flex align-items-center mt-3">
                <div className="container border border-1 rounded px-2 py-2 align-items-center mx-1" style={{width:"35%"}}>
                    <div className="h7 text-dark"><dt><i className="fa-solid fa-piggy-bank" style={{color:"#f55be1"}}></i>&nbsp;{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[0]?.info.header}</dt></div>

                    <div className="d-flex text-secondary offerText"><p className="division">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[0]?.info.couponCode}</p><p className="mx-1">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[0]?.info.description}</p></div>
                </div>

                <div className="container border border-1 rounded px-2 py-2 align-items-center mx-1" style={{width:"35%"}}>
                    <div className="h7 text-dark "><dt><i className="fa-solid fa-piggy-bank" style={{color:"#f55be1"}}></i>&nbsp;{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[1]?.info.header}</dt></div>

                    <div className="d-flex text-secondary offerText"><p className="division">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[1]?.info.couponCode}</p><p className="mx-1">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[1]?.info.description}</p></div>
                </div>

                <div className="container border border-1 rounded px-2 py-2 align-items-center mx-1" style={{width:"35%"}}>
                    <div className="h7 text-dark"><dt><i className="fa-solid fa-piggy-bank" style={{color:"#f55be1"}}></i>&nbsp;{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[2]?.info.header}</dt></div>
                    
                    <div className="d-flex text-secondary offerText"><p className="division">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[2]?.info.couponCode}</p><p className="mx-1">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[2]?.info.description}</p></div>
                </div>

                <div className="container border border-1 rounded px-2 py-2 align-items-center mx-1" style={{width:"35%"}}>
                    <div className="h7 text-dark "><dt><i className="fa-solid fa-piggy-bank" style={{color:"#f55be1"}}></i>&nbsp;{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[3]?.info.header}</dt></div>

                    <div className="d-flex text-secondary offerText"><p className="division">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[3]?.info.couponCode}</p><p className="mx-1">{menuList[1].card?.card?.gridElements?.infoWithStyle?.offers[3]?.info.description}</p></div>
                </div>
            </div>
